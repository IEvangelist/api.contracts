...
The **SampleApi** project demonstrates every major feature of the API Contracts generator. The full schema is [available as JSON](/api.contracts/schemas/SampleApi.ai-schema.json) for consumption by AI agents, documentation pipelines, and automated tooling.
...
```json title="Customer type in schema" collapse={38-70}
{
  "name": "Customer",
...
**[`/api.contracts/schemas/SampleApi.ai-schema.json`](/api.contracts/schemas/SampleApi.ai-schema.json)**
