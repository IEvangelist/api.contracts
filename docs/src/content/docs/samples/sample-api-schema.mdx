...
The **SampleApi** project demonstrates every major feature of the API Contracts generator. The full data file is [available as JSON](/api.contracts/schemas/SampleApi.api-schema.json) for consumption by AI agents, documentation pipelines, and automated tooling.
...
| Type | Kind | Members | JSON | Summary |
|---|---|---:|:---:|---|
...
<Tabs>
  ...
  <TabItem label="JSON Serialization">
    Types with `System.Text.Json` attributes are captured in the data file:
